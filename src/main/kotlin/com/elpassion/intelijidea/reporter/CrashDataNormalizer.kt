...
fun normalizeCrashData(error: ErrorBean,
    ...
    val params = mapOf("error.description" to error.description,
            ...
            "OS Name" to com.intellij.util.SystemProperties.getOsName(),
            "Java version" to com.intellij.util.SystemProperties.getJavaVersion(),
            "Java vm vendor" to com.intellij.util.SystemProperties.getJavaVmVendor(),
