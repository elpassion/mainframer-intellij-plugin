...
class SelectorResultTest {
    ...
    @Test
    fun shouldNotReplaceAllConfigurationsWhenNotSelectedInUi() {
    ...
    @Test
    fun shouldReplaceAllConfigurationsWhenSelectedInUi() {
    ...
    private fun createSelectorItem(isSelected: Boolean = false) =
            SelectorItem(mock(), isSelected = isSelected, name = "configuration")
}